...
//        out.close();
    ...
    public Repo[] parser(StringBuffer json) throws Throwable {
    ...
    public void save(Repo[] repo) throws Throwable {
        try {
    ...
    public void validate(String period, String language, String apiUrl) throws Throwable {
